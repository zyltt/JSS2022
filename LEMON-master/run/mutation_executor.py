...
if __name__ == '__main__':
    ...
    for exp_identifier in flags.exps:
        ...
        try:
            ...
            origin_model_file = flags.origin_model_dir + "/" + origin_model_name
            mutate_lemon = "python ../run/mutate_lemon.py --mutate_op {} --model {} --output_dir {}" \
                            " --backends {} --mutate_num {} --mutate_ratio {} --exp {} --test_size {} --redis_db {} --config_name {}"\
                            .format(flags.mutate_ops,".."+origin_model_file,".."+flags.output_dir,flags.backend,
